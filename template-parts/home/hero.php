...
// Preferência: PNG paciente (hero-photo) → export Figma → JPG.
$image_url = idc_theme_image('assets/images/hero-photo', 'png');
if (!is_readable(IDC_THEME_DIR . '/assets/images/hero-photo.png')
	&& !is_readable(IDC_THEME_DIR . '/assets/images/hero-photo.jpg')) {
	$image_url = idc_theme_image('assets/images/hero-photo-figma', 'png');
}
