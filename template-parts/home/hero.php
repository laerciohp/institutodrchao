...
// Preferência: PNG Figma → PNG legado → JPG.
$image_url = idc_theme_image('assets/images/hero-photo-figma', 'png');
if (!is_readable(IDC_THEME_DIR . '/assets/images/hero-photo-figma.png')) {
	$image_url = idc_theme_image('assets/images/hero-photo', 'jpg');
}
