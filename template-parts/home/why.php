...
$img_url = idc_image_url($image, idc_asset('assets/images/why-choose.jpg'));
$img_alt = idc_image_alt($image, __('Ambiente de reabilitação do Instituto Dr. Chao', 'instituto-dr-chao'));
